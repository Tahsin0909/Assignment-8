    ...
    return (
        <div className="">
                <div className="absolute top-0 ">
                    <img className="w-screen lg:h-screen h-[300px] opacity-50" src={'https://i.ibb.co/8YNchrV/banner.jpg'} alt="" />
                </div>
                <div className=" flex flex-col justify-center items-center gap-8 relative lg:top-32">
